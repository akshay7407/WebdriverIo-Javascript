...
describe('Verify password label input', () => {
    ...
    it('Validate password Label', async () => {
        ...
        await collectResponse.verifyPassLabel()
        await collectResponse.verifyPassLabelCharLength(dataSet.character[0].characterInLimit)
