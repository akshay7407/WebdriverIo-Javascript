...
describe('Verify password required  message error', () => {
    ...
    it('Validate password  required error', async () => {
        ...
        await collectResponse.verifyPassMessageError()
        await collectResponse.VerifyCharLength('Akshay')
